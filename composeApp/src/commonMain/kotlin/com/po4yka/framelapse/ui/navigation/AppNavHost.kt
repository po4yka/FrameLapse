...
/**
 * Unified navigation host for the app using Navigation 3.
 * Works on both Android and iOS platforms with state preservation.
 */
@Composable
fun AppNavHost(modifier: Modifier = Modifier) {
    val backStack = rememberNavBackStack(navKeySavedStateConfig, ProjectListKey)
